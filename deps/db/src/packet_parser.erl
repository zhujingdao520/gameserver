...
parse_result_packet(1, B, _Metadata, _) ->
  {Catalog, B1} = helper_common:extract_length_coded_string(B),
  {Schema, B2} = helper_common:extract_length_coded_string(B1),
  {Table, B3} = helper_common:extract_length_coded_string(B2),
  {OrigTable, B4} = helper_common:extract_length_coded_string(B3),
  {Name, B5} = helper_common:extract_length_coded_string(B4),
  {OrigName, B6} = helper_common:extract_length_coded_string(B5),
  ...
  {Default, Empty} = helper_common:extract_length_coded_string(DefaultBin),
  if
    size(Empty) =:= 0 ->
