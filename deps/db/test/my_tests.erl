...
tableInsert(_, C) -> fun() ->  
  ...
  , "'-755:55:43','71-01-01 00:00:01',2031,'-3459123.0070077',-20988765.88,"
  , "-5.77e-006,742387,12127,17717,122,'char symbols','\07','one','three,one',"
...
%  ?debug_Fmt("~p~n", [R2]),
  ...
  Expected = [3,739245,"This is a Varchar(45) string.",
    ...
    2031,{mysql_decimal,"-3459123","0070077"},-20988765.88,-5.77e-6,742387,
